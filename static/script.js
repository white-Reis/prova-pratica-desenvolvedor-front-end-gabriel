      ...
      switch (section) {
          ...
          case 'sobre':
              content = `
                  <section class="content">
                      <h1>Sobre Nós</h1>
                      <p>Adote seu Humano é uma iniciativa que nasceu do amor pelos gatos. Nossa missão é criar um mundo onde cada gato tenha um lar amoroso e um humano dedicado. Trabalhamos incansavelmente para conectar gatos carentes com humanos responsáveis e amorosos.</p>
                  </section>`;
              break;
          case 'servicos':
              content = `
                  <section class="content">
                      ...
                      <p>Oferecemos uma variedade de serviços para garantir que cada adoção seja um sucesso:</p>
                      <ul>
